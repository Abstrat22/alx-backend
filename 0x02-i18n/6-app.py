#!/usr/bin/env python3
"""
Flask app for rendering an HTML template with
language support and user data handling.
"""
...
def get_user() -> Union[Dict, None]:
    """
    Returns a user dictionary or None if the ID value can't be found or if
    the 'login_as' URL parameter was not found.
    """
    id = request.args.get(
